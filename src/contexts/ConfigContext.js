    ...
    switch (action.type) {
      ...
      case actionType.HEADER_FIXED_LAYOUT:
        return {
          ...
          headerBackColor:
            !state.headerFixedLayout && initialState.headerBackColor === ""
              ? "header-blue"
      ...
      case actionType.LAYOUT_TYPE:
        return {
          ...
          headerBackColor: action.headerBackColor
            ? action.headerBackColor
            : state.headerBackColor,
          navBackColor: action.navBackColor
            ? action.navBackColor
            : state.navBackColor,
          navBrandColor: action.navBrandColor
            ? action.navBrandColor
            : state.navBrandColor,
          navBackImage:
            action.layoutType === "menu-light" ? false : state.navBackImage,
        };
      case actionType.LAYOUT6_BACKGROUND:
        return {
          ...state,
          layout6Background: action.layout6Background,
          layout6BackSize: action.layout6BackSize
            ? action.layout6BackSize
            : state.layout6BackSize,
        };
