    ...
    <React.Fragment>
      ...
      <div className='media friendlist-box align-items-center justify-content-center m-b-20'>
        ...
        <div className='media-body'>
          ...
          <span className='float-right d-flex  align-items-center'>
            <i className='fa fa-caret-down f-22 m-r-10 text-c-red' /> `` 2739
          </span>
        </div>
      </div>
      <div className='media friendlist-box align-items-center justify-content-center m-b-20'>
    ...
    <React.Fragment>
      <Row>
        <Col md={6} xl={4}>
          <Card>
            <Card.Body>
              <h6 className='mb-4'>Total no. of users</h6>
        ...
        <Col md={6} xl={4}>
          <Card>
            <Card.Body>
              <h6 className='mb-4'>Total no. of programs</h6>
              <div className='row d-flex align-items-center'>
                <div className='col-9'>
                  <h3 className='f-w-300 d-flex align-items-center m-b-0'>
        ...
        <Col xl={4}>
          <Card>
            <Card.Body>
              <h6 className='mb-4'>Total no. of purchased programs</h6>
              <div className='row d-flex align-items-center'>
                <div className='col-9'>
                  <h3 className='f-w-300 d-flex align-items-center m-b-0'>
                    <i className='feather icon-arrow-up text-c-green f-30 m-r-5' />{' '}
